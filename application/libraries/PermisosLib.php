...
class PermisosLib{
    ...
    var $table = 'permisos';//Nome tabela onde ficam armazenadas as permissões
    var $pk = 'id';// Nome da chave primaria da tabela
    var $select = 'permisos';// Campo onde fica o array de permissoes.

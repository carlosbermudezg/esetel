...
<main id="main-container"> 
    <div class="content">
        ...
        <div class="block-header block-header-default">
            <h3 class="block-title">Usuarios <small>Todos</small></h3>
            <a href="<?php echo base_url()?>usuarios/agregar" class="btn btn-sm btn-success me-1 mb-3">
                <i class="fa fa-fw fa-plus me-1"></i> Nuevo Usuario
            </a>
        </div>
        <div class="block-content block-content-full">
            <!-- DataTables init on table by adding .js-dataTable-full-pagination class, functionality is initialized in js/pages/be_tables_datatables.min.js which was auto compiled from _js/pages/be_tables_datatables.js -->
            <table id="tblusuarios" class="table table-bordered table-striped table-vcenter">
            <thead>
                <tr>
                <th class="text-center" style="width: 80px;">Id</th>
                <th>Nombres</th>
                <th class="d-none d-sm-table-cell" style="width: 15%;">Usuario</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        'serverMethod': 'post',
        'ajax': {
         'url':'<?php echo base_url('/listar/usuarios');?>',
        },
        'columns': [
         { data: 'id' },
         { data: 'nombre' },

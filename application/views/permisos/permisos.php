...
<!-- Page JS Plugins -->
<script src="<?php echo base_url()?>/app-assets/src/assets/js/plugins/chart.js/chart.min.js"></script>

<!-- Page JS Code -->
<script src="<?php echo base_url()?>/app-assets/src/assets/js/pages/be_pages_dashboard.min.js"></script>
...
<main id="main-container"> 
    <div class="content">
        ...
        <div class="block-header block-header-default">
            <h3 class="block-title">Permisos <small>Todos</small></h3>
            <a href="<?php echo base_url()?>permisos/agregar" class="btn btn-sm btn-success me-1 mb-3">
                <i class="fa fa-fw fa-plus me-1"></i> Nuevo Permiso
            </a>
        </div>
        <div class="block-content block-content-full">
            <!-- DataTables init on table by adding .js-dataTable-full-pagination class, functionality is initialized in js/pages/be_tables_datatables.min.js which was auto compiled from _js/pages/be_tables_datatables.js -->
            <table id="tblpermisos" class="table table-bordered table-striped table-vcenter">
            <thead>
                <tr>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        'serverMethod': 'post',
        'ajax': {
         'url':'<?php echo base_url('/listar/permisos');?>',
        },
        'columns': [
         { data: 'id' },
         { data: 'nombre' }
